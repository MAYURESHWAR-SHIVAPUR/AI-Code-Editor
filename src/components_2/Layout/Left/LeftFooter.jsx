...
const LeftFooter = () => {
    ...
    return (
        <footer id='leftFooter' className='h-[12vh] w-full border border-[#263ba7] rounded-md mt-2  py-2 lg:flex hidden items-center justify-evenly bg-black cursor-pointer overflow-hidden'>
