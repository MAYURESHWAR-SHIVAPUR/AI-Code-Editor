    ...
    return (
        <header>
            <nav className='flex items-center justify-between h-fit w-screen overflow-hidden pt-2 lg:px-5'>
                ...
                <section className='border-2 border-[#5a75b0] font-bold px-3  py-2 rounded-md text-white md:text-lg text-xs glass hover:scale-115 transition-all duration-300'>
                    <NavLink to={"/login"}>
